...
Then Layer > New from linked. The new layer, new_from_linked, appears just 
...
version 4: Replaced the line with pdb.gimp_image_merge_layer_group() for less
           requirements
...
def python_new_from_linked(image, start_layer):
